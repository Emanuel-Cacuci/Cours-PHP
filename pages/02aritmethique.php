...
<h2>Operations et affectation combinées</h2>

<?php
// c'est une facon d'ecrire les calcules avec abreviation, pour simplifier l'ecriture.
$a=10;
$b=2;
